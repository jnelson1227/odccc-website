...
insert into public.carvers (slug,name,hometown,country,division,card_line,honor_badge,photo_path,photo_alt) values ('garrett-aries','Garrett Aries','Longbranch, WA','USA','Pro','Aries Sculptures; George Kenny School trained',null,null,null);
